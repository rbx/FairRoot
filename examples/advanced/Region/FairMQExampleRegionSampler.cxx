...
void FairMQExampleRegionSampler::Run()
{
    ...
    FairMQRegionPtr region(dataOutChannel.Transport()->CreateRegion(10000000));

    while (CheckCurrentState(RUNNING))
    {
        FairMQMessagePtr msg(dataOutChannel.Transport()->CreateMessage(region, region->GetData(), fMsgSize));

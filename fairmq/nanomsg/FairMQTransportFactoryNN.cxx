...
FairMQMessagePtr FairMQTransportFactoryNN::CreateMessage(FairMQUnmanagedRegionPtr& region, void* data, const size_t size, FairMQRegionCallback callback) const
{
    return unique_ptr<FairMQMessage>(new FairMQMessageNN(region, data, size, callback));
}
